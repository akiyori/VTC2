...
{
	for (Character* character : characters) {
		graphics->DrawCircle(character->position, 4, D2D1::ColorF(character->affiliationId, 0, 1-character->affiliationId, character->alive?1:0.4));
	}
}
